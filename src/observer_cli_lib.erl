...
%% redraw far more often than any configured display interval, and a
%% cpu_time_sample/0 pair a few milliseconds apart is dominated by
%% /proc/self/stat's 10ms tick quantization, not real CPU usage.
